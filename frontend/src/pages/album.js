...
const Album = () => {
  ...
  // Define the handleProgressChange function
...
>
  ...
  <span className="like-text">Your Favorite</span>
      ...
      <div className="songs-container">
        <Songs
          ...
          handleProgressChange={handleProgressChange} // Pass handle progress change // Pass volume as a prop
        />
      </div>
  ...
  <div className="song-controls">
    ...
    <img 
  src={isPlaying ? "/images/playy.png" : "/images/pause.png"} 
